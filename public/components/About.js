  ...
  <section id="about">
    ...
    <div>
      ...
      <ul className="bullet-points">
        <li>Provide security for the Lisk network as well as sidechain projects</li>
        <li>Giving back to the community through our rewards</li>
        <li>Ultralisk Lisk fund used to help bootstrap new Lisk based projects</li>
        <li>Promotion and marketing of those projects</li>
        <li>Creation of tutorials and guides</li>
      </ul>
    </div>
    ...
    <p>Below is our members list and required delegates.</p>
  </section>);
